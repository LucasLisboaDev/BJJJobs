          ...
          <div className="bg-white border border-gray-100 rounded-2xl p-6">
            ...
            <div className="grid grid-cols-2 gap-4 mb-5">
              ...
              <div>
                ...
                <select className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm outline-none focus:border-green-400 bg-white"
                  value={gym_state} onChange={(e) => setGym_state(e.target.value)}>
