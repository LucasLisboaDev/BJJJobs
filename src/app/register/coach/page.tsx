        ...
        <div className="flex items-center gap-2">
          {["Account", "BJJ profile", "Preferences"].map((label, i) => (
            <div key={label} className="flex items-center gap-1.5">
              ...
              <span
                className="text-xs"
                style={{ color: i === 1 ? "#0F6E56" : "#9ca3af", fontWeight: i === 1 ? 500 : 400 }}
              >
                {label}
              </span>
            </div>
      ...
      <div className="grid grid-cols-[260px_1fr] min-h-[calc(100vh-57px)]">
        ...
        <div className="p-8 max-w-xl">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <button className="text-sm px-4 py-1.5 border border-gray-200 rounded-lg bg-gray-50 text-gray-600">
                Upload photo
              </button>
          ...
          <div className="grid grid-cols-2 gap-4 mb-5">
            <div>
              ...
              <input className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm outline-none focus:border-green-400" placeholder="Lucas" />
            </div>
            <div>
              <label className="block text-xs font-medium text-gray-500 mb-1.5">Last name</label>
              <input className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm outline-none focus:border-green-400" placeholder="Lisboa" />
            </div>
          </div>
            ...
            <div className="flex gap-2 flex-wrap">
              {BELTS.map((belt) => (
                <button
                  ...
                  style={{
                    borderLeft: `4px solid ${beltColors[belt]}`,
                    background: selectedBelt === belt ? "#E1F5EE" : "white",
                    borderColor: selectedBelt === belt ? "#1D9E75" : "#e5e7eb",
                    borderLeftColor: beltColors[belt],
